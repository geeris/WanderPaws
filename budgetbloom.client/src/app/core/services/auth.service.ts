...
export class AuthService implements OnDestroy{
  // allow the access to the signal from different places or change the value
    // then all places will be automatically rerendered
    //currentUserSignal = signal<UserInterface | undefined | null>(undefined);
    // if user is not logged in already - undefined
    // null - unauthrized
    // user - loggedIn
